...
class GaussianTS(QMReaction, Gaussian):
    ...
    def runQST3(self):
        ...
        return self.verifyQST3OutputFile(), logFilePath
    ...
    def verifyQST3OutputFile(self):
        """
        Check's that a qst3 output file exists and was successful.

        Returns a boolean flag that states whether a QST3 GAUSSIAN simulation that hasn't failed already exists for the molecule with the
        given file name.
